...
export const exercises = [
  /* ─────  BICEPS  (11)  ───── */
  {
    ...
    equipment: "Barbell", target: "biceps", pattern: "isolation",
    secondary: ["forearms"],
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "biceps", pattern: "isolation",
    secondary: ["forearms"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Cable", target: "biceps", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Machine", target: "biceps", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  /* ─────  TRICEPS  (12)  ───── */
  {
    ...
    equipment: "Barbell", target: "triceps", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Barbell", target: "triceps", pattern: "isolation",
    secondary: ["forearms"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Cable", target: "triceps", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "triceps", pattern: "isolation",
    secondary: ["chest", "shoulders"],
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "triceps", pattern: "compound",
    secondary: ["chest", "shoulders"],
  ...
  },
  {
    ...
    equipment: "Machine", target: "triceps", pattern: "compound",
    secondary: ["chest", "shoulders"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  /* ─────  FOREARMS  (10)  ───── */
  {
    ...
    equipment: "Barbell", target: "forearms", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "forearms", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Cable", target: "forearms", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 15–20",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "forearms", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "forearms", pattern: "isolation",
    secondary: [],
