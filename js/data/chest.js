...
export const exercises = [
  /* ─────  MID CHEST  (10)  ───── */
  {
    ...
    equipment: "Barbell", target: "mid_chest", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "mid_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
  ...
  },
  {
    ...
    equipment: "Machine", target: "mid_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3–4 × 8–12",
  ...
  },
  {
    ...
    equipment: "Machine", target: "mid_chest", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Cable", target: "mid_chest", pattern: "isolation",
    secondary: ["shoulders"],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "mid_chest", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "mid_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
  ...
  /* ─────  UPPER CHEST  (10)  ───── */
  {
    ...
    equipment: "Barbell", target: "upper_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "4 × 6–10",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "upper_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3–4 × 8–12",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "upper_chest", pattern: "isolation",
    secondary: ["shoulders"],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Cable", target: "upper_chest", pattern: "isolation",
    secondary: ["shoulders"],
    level: "Intermediate", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Cable", target: "upper_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Machine", target: "upper_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "upper_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3 × as many as you can",
  ...
  /* ─────  LOWER CHEST  (10)  ───── */
  {
    ...
    equipment: "Barbell", target: "lower_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3–4 × 8–12",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "lower_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3 × 8–12",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "lower_chest", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "lower_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
  ...
  },
  {
    ...
    equipment: "Cable", target: "lower_chest", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Machine", target: "lower_chest", pattern: "compound",
    secondary: ["shoulders", "triceps"],
    level: "Beginner", setsReps: "3 × 10–12",
