...
export const exercises = [
  /* ─────  LOWER ABS  (12)  ───── */
  {
    ...
    equipment: "Bodyweight", target: "lower_abs", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Cable", target: "lower_abs", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
...

  {
    ...
    equipment: "Machine", target: "lower_abs", pattern: "isolation",
    secondary: [],
  ...
  /* ─────  UPPER ABS  (11)  ───── */
  {
    ...
    equipment: "Bodyweight", target: "upper_abs", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 15–20",
  ...
  },
  {
    ...
    equipment: "Cable", target: "upper_abs", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Machine", target: "upper_abs", pattern: "isolation",
    secondary: [],
    level: "Intermediate", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Barbell", target: "upper_abs", pattern: "compound",
  ...
  /* ─────  OBLIQUES  (11)  ───── */
  {
    ...
    equipment: "Bodyweight", target: "obliques", pattern: "isolation",
    secondary: ["erectors"],
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "obliques", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15 each side",
  ...
  },
  {
    ...
    equipment: "Barbell", target: "obliques", pattern: "isolation",
    secondary: ["erectors"],
    level: "Beginner", setsReps: "3 × 12–15 each side",
  ...
  },
  {
    ...
    equipment: "Cable", target: "obliques", pattern: "isolation",
    secondary: ["shoulders"],
    level: "Beginner", setsReps: "3 × 12–15 each side",
