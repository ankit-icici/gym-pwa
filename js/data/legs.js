...
export const exercises = [
  /* ─────  QUADS  (13)  ───── */
  {
    ...
    equipment: "Barbell", target: "quads", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Machine", target: "quads", pattern: "compound",
    secondary: ["calves", "glutes", "hamstrings"],
  ...
  },
  {
    ...
    equipment: "Machine", target: "quads", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "quads", pattern: "compound",
    secondary: ["calves", "glutes", "hamstrings"],
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "quads", pattern: "compound",
    secondary: ["glutes", "hamstrings"],
  ...
  /* ─────  HAMSTRINGS  (11)  ───── */
  {
    ...
    equipment: "Barbell", target: "hamstrings", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "hamstrings", pattern: "compound",
    secondary: ["glutes", "erectors"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Machine", target: "hamstrings", pattern: "compound",
    secondary: ["glutes", "erectors"],
  ...
  },
  {
    ...
    equipment: "Machine", target: "hamstrings", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3–4 × 10–12",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "hamstrings", pattern: "isolation",
    secondary: ["calves", "glutes", "erectors"],
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "glutes", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "glutes", pattern: "isolation",
    secondary: ["hamstrings"],
  ...
  },
  {
    ...
    equipment: "Cable", target: "glutes", pattern: "isolation",
    secondary: ["hamstrings"],
  ...
  },
  {
    ...
    equipment: "Cable", target: "glutes", pattern: "compound",
  ...
  /* ─────  CALVES  (10)  ───── */
  {
    ...
    equipment: "Machine", target: "calves", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Barbell", target: "calves", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "calves", pattern: "isolation",
    secondary: [],
