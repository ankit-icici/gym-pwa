...
export const exercises = [
  /* ─────  LATS  (12)  ───── */
  {
    ...
    equipment: "Cable", target: "lats", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Cable", target: "lats", pattern: "isolation",
    secondary: [],
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "lats", pattern: "compound",
    secondary: ["biceps", "rhomboids"],
  ...
  },
  {
    ...
    equipment: "Barbell", target: "lats", pattern: "isolation",
  ...
  },
  {
    ...
    equipment: "Machine", target: "lats", pattern: "compound",
    secondary: ["biceps", "rhomboids"],
  ...
  /* ─────  UPPER BACK  (13)  ───── */
  {
    ...
    equipment: "Barbell", target: "rhomboids", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Cable", target: "rhomboids", pattern: "compound",
    secondary: ["biceps", "lats", "rear_delts"],
    level: "Beginner", setsReps: "3–4 × 10–12",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "rhomboids", pattern: "compound",
    secondary: ["biceps", "lats", "rear_delts"],
    level: "Beginner", setsReps: "3 × 10–12 each side",
  ...
  },
  {
    ...
    equipment: "Machine", target: "rhomboids", pattern: "compound",
    secondary: ["lats"],
    level: "Beginner", setsReps: "3 × 10–12",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "rhomboids", pattern: "compound",
    secondary: ["lats"],
  ...
  /* ─────  LOWER BACK  (9)  ───── */
  {
    ...
    equipment: "Barbell", target: "erectors", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Machine", target: "erectors", pattern: "isolation",
  ...
  },
  {
    ...
    equipment: "Bodyweight", target: "erectors", pattern: "isolation",
    secondary: ["glutes", "hamstrings"],
  ...
  /* ─────  REAR DELTS  (10)  ───── */
  {
    ...
    equipment: "Cable", target: "rear_delts", pattern: "compound",
    secondary: ["rhomboids"],
  ...
  },
  {
    ...
    equipment: "Cable", target: "rear_delts", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Machine", target: "rear_delts", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
  ...
  },
  {
    ...
    equipment: "Barbell", target: "rear_delts", pattern: "compound",
  ...
  },
  {
    ...
    equipment: "Dumbbell", target: "rear_delts", pattern: "isolation",
    secondary: [],
    level: "Beginner", setsReps: "3 × 12–15",
